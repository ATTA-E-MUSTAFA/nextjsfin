...
import { HiExternalLink } from "react-icons/hi";
import { BsGithub } from "react-icons/bs";
import { ProjectsData } from "@/constants"; // Assuming your data is here
        ...
        >
          {ProjectsData.map((project) => (
            ...
            >
              ...
              <div
                className={`
                  w-[330px] shadow-md shadow-zinc-300 dark:shadow-zinc-700 
                  h-48 bg-no-repeat flex flex-col justify-end 
                  rounded overflow-hidden bg-cover
                `}
                onMouseLeave={() => setHeight1("")}
                onMouseMove={() => setHeight1(project.projectName)}
                style={{
              ...
              >
                ...
                >
                  ...
                  >
                    {/* If the project has an internal route, use Link for internal navigation */}
                    {project.route ? (
                      <Link
                        className='text-xl text-white p-1 bg-gray-700 hover:bg-gray-950 rounded'
                        href={project.route} // Internal route for IP lookup
                      >
                        <HiExternalLink />
                      </Link>
                    ) : (
